...
> [!WARNING]
> 项目目前处于 Alpha 阶段，最新预发布版本为 `v0.3.0-alpha.2`，尚未发布稳定版本。GitHub Release 提供经过 CI 验证的 Web、Agent、Relay 和 HPC 部署工具制品；协议、配置和存储结构仍可能变化，现阶段建议用于个人环境或可信团队试用。
